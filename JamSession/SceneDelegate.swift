...
//        let contentView = ProfileForm(user: User(email: "ckoehne@purdue.edu", firstName: "Chris", lastName: "Koehne", password: "",
...
//                                                               genre0: Genre.alt,genre1: Genre.none, genre2: Genre.none, bio: "Fuck bios"))
        
        let contentView = WelcomeHost().environmentObject(User()).environmentObject(UserStatus())
